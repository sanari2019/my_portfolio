...
@Component({
  ...
  template: `
    ...
    <h2 class="mb-8 lg:mb-16 text-xl font-bold tracking-tight leading-tight text-center text-gray-900 dark:text-white md:text-xl">Languages and Digital Arsenal</h2>
