...
@Component({
  ...
  template: `
    <section class="mt-16">
      ...
      <h2 class="mb-8 lg:mb-16 text-xl font-bold tracking-tight leading-tight text-center text-gray-900 dark:text-white md:text-xl">Crafting Digital Excellence Across</h2>
